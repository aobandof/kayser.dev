...
final class DB
{
  public $query_count = 0; //int
  private $link = false; // mysqli
  private $connected = false; // bool
  private $mysqlDefaultTimeFunctions; // array
  private $hostname = ''; // string
  private $username = ''; // string
  private $password = ''; // string
  private $database = ''; // string
  private $port = 3306; // int
  private $charset = 'utf8'; // string
  private $socket = ''; // string
  private $session_to_db = false; // bool
  private $_in_transaction = false; // bool
  private $_convert_null_to_empty_string = false; // bool
  private $_ssl = false; // bool
  private $_clientkey; // string // The path name to the key file
  private $_clientcert; // string // The path name to the certificate file
  private $_cacert; // string // The path name to the certificate authority file
