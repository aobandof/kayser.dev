...
function llenarSelect(tabla){
    $("#select_tienda").append('<option value=0></option><option value=-1>PROMOTORAS CON TIENDA</option><option value=-2>PROMOTORAS SIN TIENDA</option>');
     ...
     $.ajax({ data:  parametros, url: 'modelo.php', type:  'post', dataType: "json",
         success: function(data){
             ...
             $.each(data, function(index){
                ...
                fila="<tr class='fila'><td>"+ i +"</td><td>"+data[index].tienda +"</td><td>"+data[index].rut +"</td><td>"+data[index].nombres +"</td><td><a href='tel:"+data[index].celular +"'>"+data[index].celular +"</a></td><td><a href='tel:"+data[index].telefono +"'>"+data[index].telefono +"</a></td><td>"+data[index].email +"</td><td>"+data[index].direccion +"</td><td>"+data[index].comuna +"</td><td>"+data[index].ciudad +"</td><td>"+data[index].cumple +"</td><td>"+data[index].ultima + "</td><td>"+data[index].monto +"</td></tr>";
