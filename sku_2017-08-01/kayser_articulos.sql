...
INSERT INTO `articulo` VALUES ('S6022',1,'S6022-PIJAMA PANTALON ALGODON',2,'SIMPSONS',106,'dama',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',3,'MUJER',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T03'),('S6023',1,'S6023-PIJAMA PANTALON ALGODON',2,'SIMPSONS',106,'dama',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',3,'MUJER',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T03'),('S6024',1,'S6024-PIJAMA PANTALON ALGODON',2,'SIMPSONS',106,'dama',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',3,'MUJER',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T03'),('S6329',1,'S6329-PIJAMA PANTALON ALGODON',2,'SIMPSONS',129,'niña',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',4,'JUVENIL',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T30'),('S6330',1,'S6330-PIJAMA PANTALON ALGODON',2,'SIMPSONS',129,'niña',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',1,'NIÑOS',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T30'),('S6331',1,'S6331-PIJAMA PANTALON ALGODON',2,'SIMPSONS',129,'niña',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',1,'NIÑOS',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T30'),('S6528',1,'S6528-PIJAMA PANTALON ALGODON',2,'SIMPSONS',127,'lola',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',4,'JUVENIL',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T30'),('S6529',1,'S6529-PIJAMA PANTALON ALGODON',2,'SIMPSONS',127,'lola',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',4,'JUVENIL',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T30'),('S6530',1,'S6530-PIJAMA PANTALON ALGODON',2,'SIMPSONS',127,'lola',8,'LENCERIA','22','PIJAMA','01','PANTALON',1,'UNITARIO',2,'ALGODON',1,'INVIERNO',5,'INV18',4,'JUVENIL',2,'OTRA CARACTERISTICA',12,'60% ALGODON 40% POLIESTER ( CVC)','T30');
...
INSERT INTO `dpto_subdpto` VALUES (106,1),(106,2),(106,3),(108,3),(127,3),(128,3),(129,3),(130,3),(145,3),(105,4),(106,5),(127,5),(129,5),(106,6),(103,8),(106,8),(108,8),(127,8),(128,8),(129,8),(130,8),(106,9),(106,10),(106,11),(147,12),(106,13),(108,13),(106,14),(106,15),(106,16),(108,17),(128,17),(130,17),(106,18);
...
INSERT INTO `lista` VALUES (1,'','CREADA');
...
INSERT INTO `lista_has_usuario` VALUES (1,'comex','CREACION','2017-12-06 17:50:43');
...
INSERT INTO `prenda_copa` VALUES ('25',1),('25',2),('13',3),('25',3),('25',4),('25',5),('25',6);
...
INSERT INTO `prenda_talla` VALUES ('03','T02'),('22','T02'),('02','T03'),('03','T03'),('06','T03'),('07','T03'),('09','T03'),('10','T03'),('11','T03'),('12','T03'),('13','T03'),('14','T03'),('17','T03'),('21','T03'),('22','T03'),('25','T03'),('33','T03'),('34','T03'),('40','T03'),('41','T03'),('42','T03'),('43','T03'),('47','T03'),('49','T03'),('50','T03'),('08','T04'),('21','T04'),('13','T05'),('14','T05'),('25','T05'),('47','T05'),('09','T06'),('17','T06'),('41','T06'),('42','T06'),('01','T07'),('02','T07'),('07','T07'),('08','T07'),('09','T07'),('12','T07'),('15','T07'),('16','T07'),('18','T07'),('20','T07'),('21','T07'),('22','T07'),('25','T07'),('28','T07'),('31','T07'),('32','T07'),('34','T07'),('35','T07'),('36','T07'),('37','T07'),('38','T07'),('41','T07'),('45','T07'),('46','T07'),('47','T07'),('48','T07'),('49','T07'),('08','T17'),('26','T17'),('32','T17'),('25','T24'),('32','T24'),('07','T30'),('09','T30'),('10','T30'),('11','T30'),('12','T30'),('22','T30'),('25','T30'),('32','T30'),('42','T30'),('08','T32'),('08','T33'),('39','T33'),('08','T34'),('39','T34');
...
CREATE TABLE `sku` (
  ...
  `color_name` varchar(85) DEFAULT NULL,
  `talla_name` varchar(10) DEFAULT NULL,
  `talla_orden` int(11) DEFAULT NULL,
  `copa` varchar(10) DEFAULT NULL,
  `fcopa` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`codigo`),
...
INSERT INTO `sku` VALUES ('S6022-GRI-L','S6022','7800010000518',67,'GRIS','L',3,'',''),('S6022-GRI-M','S6022','7800010000501',67,'GRIS','M',2,'',''),('S6022-GRI-S','S6022','7800010000495',67,'GRIS','S',1,'',''),('S6022-GRI-XL','S6022','7800010000525',67,'GRIS','XL',4,'',''),('S6023-ROS-L','S6023','7800010000556',127,'ROSADO','L',3,'',''),('S6023-ROS-M','S6023','7800010000549',127,'ROSADO','M',2,'',''),('S6023-ROS-S','S6023','7800010000532',127,'ROSADO','S',1,'',''),('S6023-ROS-XL','S6023','7800010000563',127,'ROSADO','XL',4,'',''),('S6024-ROS-L','S6024','7800010000594',127,'ROSADO','L',3,'',''),('S6024-ROS-M','S6024','7800010000587',127,'ROSADO','M',2,'',''),('S6024-ROS-S','S6024','7800010000570',127,'ROSADO','S',1,'',''),('S6024-ROS-XL','S6024','7800010000600',127,'ROSADO','XL',4,'',''),('S6329-GRI-10','S6329','7800010000730',67,'GRIS','10',6,'',''),('S6329-GRI-4','S6329','7800010000709',67,'GRIS','4',3,'',''),('S6329-GRI-6','S6329','7800010000716',67,'GRIS','6',4,'',''),('S6329-GRI-8','S6329','7800010000723',67,'GRIS','8',5,'',''),('S6330-CEL-10','S6330','7800010000778',32,'CELESTE','10',6,'',''),('S6330-CEL-4','S6330','7800010000747',32,'CELESTE','4',3,'',''),('S6330-CEL-6','S6330','7800010000754',32,'CELESTE','6',4,'',''),('S6330-CEL-8','S6330','7800010000761',32,'CELESTE','8',5,'',''),('S6331-ROS-10','S6331','7800010000815',127,'ROSADO','10',6,'',''),('S6331-ROS-4','S6331','7800010000785',127,'ROSADO','4',3,'',''),('S6331-ROS-6','S6331','7800010000792',127,'ROSADO','6',4,'',''),('S6331-ROS-8','S6331','7800010000808',127,'ROSADO','8',5,'',''),('S6528-ROS-12','S6528','7800010000617',127,'ROSADO','12',7,'',''),('S6528-ROS-14','S6528','7800010000624',127,'ROSADO','14',8,'',''),('S6528-ROS-16','S6528','7800010000631',127,'ROSADO','16',9,'',''),('S6529-CRE-12','S6529','7800010000648',49,'CREMA','12',7,'',''),('S6529-CRE-14','S6529','7800010000655',49,'CREMA','14',8,'',''),('S6529-CRE-16','S6529','7800010000662',49,'CREMA','16',9,'',''),('S6530-GRI-12','S6530','7800010000679',67,'GRIS','12',7,'',''),('S6530-GRI-14','S6530','7800010000686',67,'GRIS','14',8,'',''),('S6530-GRI-16','S6530','7800010000693',67,'GRIS','16',9,'','');
...
INSERT INTO `skucreated` VALUES ('101.15-AZU-2','2017-12-05','gpassi','gpassi','mmora'),('101.15-AZU-3','2017-12-05','gpassi','gpassi','mmora'),('101.15-BUR-2','2017-12-05','gpassi','gpassi','mmora'),('101.15-BUR-3','2017-12-05','gpassi','gpassi','mmora'),('101.15-MOR-2','2017-12-05','gpassi','gpassi','mmora'),('101.15-MOR-3','2017-12-05','gpassi','gpassi','mmora'),('101.15-MOS-2','2017-12-05','gpassi','gpassi','mmora'),('101.15-MOS-3','2017-12-05','gpassi','gpassi','mmora'),('101.15-NEG-2','2017-12-05','gpassi','gpassi','mmora'),('101.15-NEG-3','2017-12-05','gpassi','gpassi','mmora'),('60.1167-LIL-L','2017-12-05','gpassi','gpassi','mmora'),('60.1167-LIL-M','2017-12-05','gpassi','gpassi','mmora'),('60.1167-LIL-S','2017-12-05','gpassi','gpassi','mmora'),('60.1167-LIL-XL','2017-12-05','gpassi','gpassi','mmora'),('60.1167-ROS-L','2017-12-05','gpassi','gpassi','mmora'),('60.1167-ROS-M','2017-12-05','gpassi','gpassi','mmora'),('60.1167-ROS-S','2017-12-05','gpassi','gpassi','mmora'),('60.1167-ROS-XL','2017-12-05','gpassi','gpassi','mmora'),('63.1167-LIL-10','2017-12-05','gpassi','gpassi','mmora'),('63.1167-LIL-4','2017-12-05','gpassi','gpassi','mmora'),('63.1167-LIL-6','2017-12-05','gpassi','gpassi','mmora'),('63.1167-LIL-8','2017-12-05','gpassi','gpassi','mmora'),('63.1167-ROS-10','2017-12-05','gpassi','gpassi','mmora'),('63.1167-ROS-4','2017-12-05','gpassi','gpassi','mmora'),('63.1167-ROS-6','2017-12-05','gpassi','gpassi','mmora'),('63.1167-ROS-8','2017-12-05','gpassi','gpassi','mmora'),('64.1160-CAF-10','2017-12-05','gpassi','gpassi','mmora'),('64.1160-CAF-4','2017-12-05','gpassi','gpassi','mmora'),('64.1160-CAF-6','2017-12-05','gpassi','gpassi','mmora'),('64.1160-CAF-8','2017-12-05','gpassi','gpassi','mmora'),('64.1160-NEG-10','2017-12-05','gpassi','gpassi','mmora'),('64.1160-NEG-4','2017-12-05','gpassi','gpassi','mmora'),('64.1160-NEG-6','2017-12-05','gpassi','gpassi','mmora'),('64.1160-NEG-8','2017-12-05','gpassi','gpassi','mmora'),('65.1167-LIL-12','2017-12-05','gpassi','gpassi','mmora'),('65.1167-LIL-14','2017-12-05','gpassi','gpassi','mmora'),('65.1167-LIL-16','2017-12-05','gpassi','gpassi','mmora'),('65.1167-ROS-12','2017-12-05','gpassi','gpassi','mmora'),('65.1167-ROS-14','2017-12-05','gpassi','gpassi','mmora'),('65.1167-ROS-16','2017-12-05','gpassi','gpassi','mmora'),('67.1160-CAF-L','2017-12-05','gpassi','gpassi','mmora'),('67.1160-CAF-M','2017-12-05','gpassi','gpassi','mmora'),('67.1160-CAF-S','2017-12-05','gpassi','gpassi','mmora'),('67.1160-CAF-XL','2017-12-05','gpassi','gpassi','mmora'),('67.1160-NEG-L','2017-12-05','gpassi','gpassi','mmora'),('67.1160-NEG-M','2017-12-05','gpassi','gpassi','mmora'),('67.1160-NEG-S','2017-12-05','gpassi','gpassi','mmora'),('67.1160-NEG-XL','2017-12-05','gpassi','gpassi','mmora');
...
INSERT INTO `tcatalogo` VALUES (1,'DESCONTINUADO'),(2,'EVD'),(3,'EVD/COL'),(4,'INV17'),(5,'INV18'),(6,'LIMAS'),(7,'OUTLET'),(8,'STOCK LOT'),(9,'VER17'),(10,'VER18'),(11,'VER19');
...
-- Dump completed on 2017-12-06 18:22:49
