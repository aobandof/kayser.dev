...
SELECT TOP 10 * FROM PFNC


SELECT TOP 10 * from [dbo].[Kayser_OITM]


SELECT ItemCode,U_APOLLO_SEG1  FROM Kayser_OITM WHERE SUBSTRING(U_APOLLO_SEG1,0,6) !=  SUBSTRING(ItemCode,0,6)